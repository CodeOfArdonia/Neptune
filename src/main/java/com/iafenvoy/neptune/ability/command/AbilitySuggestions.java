...
public final class AbilitySuggestions {
    public static final SuggestionProvider<CommandSourceStack> ABILITY_CATEGORY = SuggestionProviders.register(Neptune.id("ability_category"), (context, builder) -> SharedSuggestionProvider.suggestResource(NeptuneRegistries.ABILITY_CATEGORY.holders().map(x -> x.key().location()), builder));
