...
public class EntityUtil {
    ...
    public static <M extends MobEntity> void summon(EntityType<M> entityType, ServerWorld world, double x, double y, double z, float yaw) {
        MobEntity entityToSpawn = entityType.create(world);
        if (entityToSpawn != null) {
            entityToSpawn.refreshPositionAndAngles(x, y, z, yaw, 0);
